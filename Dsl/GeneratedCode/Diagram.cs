...
namespace Company.DCMLRACPGProyectoIPS
{
	...
	public partial class DCMLRACPGProyectoIPSDiagram : DslDiagrams::Diagram
	{
		...
		protected override void InitializeShapeFields(global::System.Collections.Generic.IList<DslDiagrams::ShapeField> shapeFields)
		{
			...
			global::Company.DCMLRACPGProyectoIPS.ExampleShape.DecoratorsInitialized += ExampleShapeDecoratorMap.OnDecoratorsInitialized;
		}
		...
		private global::Company.DCMLRACPGProyectoIPS.ExampleRelationshipConnectAction exampleRelationshipConnectAction;
		/// <summary>
		...
		public override void OnViewMouseEnter(DslDiagrams::DiagramPointEventArgs pointArgs)
		{
			...
			if(activeView != null)
			{
				...
				if (SelectedToolboxItemSupportsFilterString(activeView, global::Company.DCMLRACPGProyectoIPS.DCMLRACPGProyectoIPSToolboxHelper.ExampleRelationshipFilterString))
				{
					if (this.exampleRelationshipConnectAction == null)
					{
						this.exampleRelationshipConnectAction = new global::Company.DCMLRACPGProyectoIPS.ExampleRelationshipConnectAction(this);
		...
		internal sealed class ConnectorRolePlayerChanged : DslModeling::RolePlayerChangeRule
		{
			...
			public override void RolePlayerChanged(DslModeling::RolePlayerChangedEventArgs e)
			{
				...
				foreach (DslDiagrams::PresentationViewsSubject connectorLink in connectorLinks)
				{
					...
					if (linkShape != null)
					{
						global::Company.DCMLRACPGProyectoIPS.DCMLRACPGProyectoIPSDiagram diagram = linkShape.Diagram as global::Company.DCMLRACPGProyectoIPS.DCMLRACPGProyectoIPSDiagram;
						if (diagram != null)
						{
