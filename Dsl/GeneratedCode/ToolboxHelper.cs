			...
			switch(itemId)
			{
				case "Company.DCMLRACPGProyectoIPS.ExampleElementToolboxItem":
					...
					result = new DslDesign::ModelingToolboxItem(
						...
						CreateElementToolPrototype(store, global::Company.DCMLRACPGProyectoIPS.ExampleElement.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
